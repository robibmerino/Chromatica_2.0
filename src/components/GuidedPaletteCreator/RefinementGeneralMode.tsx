...
interface RefinementGeneralModeProps {
  ...
  /** Incrementa al reiniciar paleta para resetear posiciones de los sliders. */
  restoreKey?: number;
}
...
export function RefinementGeneralMode({
  ...
  >(null);
  const [sliderTone, setSliderTone] = useState(0);
  const [sliderSat, setSliderSat] = useState(0);
  const [sliderLight, setSliderLight] = useState(0);
