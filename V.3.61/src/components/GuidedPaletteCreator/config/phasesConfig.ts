...
const FLOW_ACCENT_MAP: Record<InspirationMode, FlowAccent> = {
  ...
  'archetypes-menu': {
    active: '#c026d3',
    activeBg: 'rgba(192, 38, 211, 0.18)',
    activeRing: 'rgba(244, 114, 182, 0.38)',
    completed: '#d946ef',
    completedBg: 'rgba(217, 70, 239, 0.1)',
    completedBorder: 'rgba(244, 114, 182, 0.24)',
    particle: '#f0abfc',
  },
  archetypes: {
    active: '#c026d3',
  ...
  shapes: {
    active: '#6d28d9',
    activeBg: 'rgba(109, 40, 217, 0.16)',
    activeRing: 'rgba(167, 139, 250, 0.35)',
    completed: '#8b5cf6',
    completedBg: 'rgba(139, 92, 246, 0.1)',
    completedBorder: 'rgba(167, 139, 250, 0.22)',
    particle: '#a78bfa',
  },
  aquarium: {
    active: '#b45309',
    activeBg: 'rgba(180, 83, 9, 0.2)',
    activeRing: 'rgba(251, 191, 36, 0.35)',
    completed: '#d97706',
    completedBg: 'rgba(217, 119, 6, 0.12)',
    completedBorder: 'rgba(245, 158, 11, 0.28)',
    particle: '#fbbf24',
  },
  design: {
    active: '#0f766e',
