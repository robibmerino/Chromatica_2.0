...
**Despliegue (desde `V.3.61/`, con el proyecto ya enlazado con `supabase link`):**

- Con npm: `npm run supabase:deploy-delete-user`
- O: `supabase functions deploy delete-user-after-decline`
